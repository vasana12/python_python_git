class sungjuk:
    ...
    def input_sungjuk(self):
        ...
        self.data['hakbun']=self._hakbun
        self.data['irum'] = self._irum
        self.data['kor'] = self._kor
        self.data['eng'] = self._eng
        self.data['math'] = self._math
    ...
    def process_sungjuk(self):
        ...
        if self._avg>= 90:
            ...
            self._grade = "가"
        self.data['tot']=self._tot
        self.data['avg']=self._avg
