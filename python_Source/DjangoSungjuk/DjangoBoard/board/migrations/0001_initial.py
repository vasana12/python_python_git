# Generated by Django 2.1.2 on 2018-10-17 02:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='DjangoBoard',
            fields=[
                ('hakbun', models.CharField(max_length=50, primary_key=True, serialize=False)),
                ('irum', models.CharField(blank=True, max_length=50)),
