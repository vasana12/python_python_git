...
#[CODE 3]
def getFacebookPost(page_id, acess_token, from_date,to_date, num_statuses):
    base = "https://graph.facebook.com"
    ...
    parameters = "&limit=%s&access_token=%s" %(num_statuses,acess_token)
...
def getPostData(post, access_token, jsonResult):
    ...
    post_num_likes = post_num_reactions if post_created_time < '2016-02024 00:00:00' else post_num_likes
...
#[CODE 6]
def main():
    page_name = "1839811766137549" #page_id 입력
    access_token = "378587619347850|h0aO-0xTQSBNz9E9H_cQC2GtONM"
